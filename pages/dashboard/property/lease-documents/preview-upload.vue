          ...
          <div class="flex-1 lg:w-6/12 lg:p-10 bg-gray-25">
            ...
            <div contenteditable="true" class="border border-gray-300 lg:px-10 bg-white pb-4 px-4 outline-none border-none rounded-lg shadow-sm min-h-[500px]" ref="signatureSection">
              ...
              <div class="mb-4">
                ...
                <img :src="emittedAgreementData?.signatureObj?.url || leaseSignatureUrl" alt="Signature" class="w-full h-[200px] w-auto object-fill mix-blend-multiply border-b-2 border-dotted py-2 mb-4 bg-transparent outline-none placeholder-gray-400" />
