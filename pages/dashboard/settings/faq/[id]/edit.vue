  ...
  <LayoutWithoutSidebar>
    <div class="flex flex-col min-h-screen">
      ...
      <div class="p-6 space-y-6 w-full max-w-xl mx-auto flex-1">
        ...
        <div class="space-y-4">
          <div>
            ...
            <select disabled v-model="form.audience"
          ...
          <div>
            ...
            <input v-model="form.question" type="text" placeholder="Enter your question e.g How old are you?"
      ...
      <div class="sticky bottom-0 flex justify-between items-center space-x-4 p-4 border-t bg-white">
        <button @click="$emit('close')" class="px-6 py-3 bg-[#EBE5E0] text-gray-800 text-sm rounded-lg">
          Cancel
        </button>
