  ...
  <main class="">
    ...
    <div>
      <div class="bg-white rounded-lg overflow-hidden">
        <div class="custom-scrollbar-container w-full">
          <table class="min-w-full bg-white w-full">
            ...
            <tbody v-if="!loadingTenants" class="divide-y divide-gray-50 z-10">
              <tr class="cursor-pointer" v-for="(tenant, index) in tenantsList" :key="tenant.id">
                <!-- <td
        ...
        <CorePagination v-if="!loadingTenants && tenantsList.length > 0" :total="metadata.total" :page="metadata.page"
      ...
      ></div> -->
      <div v-if="!loadingTenants && tenantsList.length === 0" class="flex justify-center items-center flex-col my-20">
...
const tenantsCustomHeaders = {
  'firstName': 'First Name',
  'rentalApplication.house.name': 'Current Home',
  'rentalApplication.room.name': 'Room Number',
  'rentalApplication.room.rentFrequency': 'Frequency',
  'house.paymentCount': 'Payment Count',
...
const downloadData = (exportType: any) => {
  ...
  exportPaginatedData('/tenants', exportType, 'tenant_data_export', visibleColumnKeys, tenantsCustomHeaders);
};
