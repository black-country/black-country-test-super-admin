      ...
      <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 justify-between">
        <div class="flex items-center gap-x-4">
          ...
          <button @click="router.push('/dashboard/property')"
            class="bg-[#5B8469] font-medium px-4 py-3 rounded-md text-white">Listings</button>
          <button @click="router.push('/dashboard/property/rental-applications')"
            class="text-[#292929] font-medium bg-[#F0F2F5] px-4 py-3 rounded-md">Rental applications</button>
          <button @click="router.push('/dashboard/property/lease-documents')"
            class="text-[#292929] font-medium bg-[#F0F2F5] px-4 py-3 rounded-md">Lease Documents</button>
        </div>
      ...
      <div class="p-6">
        <nav class="mb-4">
          <ul class="flex space-x-4">
            <li><a href="#" class="text-green-700 font-medium border-b-4 border-[#326543] pb-1">All Applications</a>
            </li>
          ...
          <div v-for="(application, index) in applications" :key="index"
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <img :src="application.applicant.image" alt="Applicant Image"
