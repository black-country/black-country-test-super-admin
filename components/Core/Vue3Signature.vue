...
<template>
  <div class="bg-white rounded-lg mt-3">
    <!-- <h2 class="text-lg font-medium mb-4 text-[#1D2739]">Signature</h2> -->
    ...
    <div v-if="savedSignature" class="flex flex-col items-center">
     ...
     <!-- <div v-if="!loading">
      <div v-if="savedSignature" class="mt-6 p-4 sm:p-6 lg:p-8 rounded-lg border border-gray-50 bg-[#F0F2F5]">
        <h3 class="text-sm font-medium mb-2">Saved Signature:</h3>
        <img 
          :src="savedSignature" 
          alt="Signature" 
          class="border p-2 h-40 sm:h-48 lg:h-56 w-full object-cover rounded max-w-xs" 
        />
      </div>
    </div>
    <section v-else>
      <div class="animate-pulse flex space-x-4 h-20 bg-gray-100 rounded-md p-4 sm:p-6 lg:p-8 w-full mx-auto mt-10"></div>
    </section> -->
