...
export const users_api = {
    $_fetch_users: (metadata: { page: number; perPage: number }, filters: any) => {
        let url = `/tenants?page=${metadata.page}&perPage=${metadata.perPage}&isHomeOwner=false`;
      ...
      $_fetch_maintenance_request: (tenantId?: string | number, page = 1, perPage = 100000000) => {
